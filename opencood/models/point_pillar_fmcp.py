...
from opencood.models.fmcp_modules.base_bev_backbone_resnet import ResNetBEVBackbone
from opencood.models.fmcp_modules.attentioncomm import ScaledDotProductAttention, AttenComm
from opencood.models.fmcp_modules.sensor_blocks import ImgCamEncode
...
class MultiModalFusion(nn.Module):
    ...
    def forward(self, feats, modality_adapter):
        ...
        for i in range(len(feats)):
            embed = modality_adapter.wweight[0].unsqueeze(-1).unsqueeze(-1)
...
class PointPillarFMCP(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarFMCP, self).__init__()
        # cuda选择
