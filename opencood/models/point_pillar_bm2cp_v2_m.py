...
from opencood.models.bm2cpv2m_modules.where2comm_attn import Where2comm
from opencood.models.bm2cpv2m_modules.base_bev_backbone_resnet import ResNetBEVBackbone


class PointPillarBM2CPV2M(nn.Module):
    def __init__(self, args):
        super(PointPillarBM2CPV2M, self).__init__()
