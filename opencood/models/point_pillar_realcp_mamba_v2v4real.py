...
from opencood.models.realcp_modules.attentioncomm_corr_shapley_mamba2 import AttenComm
...
class PointPillarRealCPMambaV2V4Real(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarRealCPMambaV2V4Real, self).__init__()
        # cuda选择
        ...
        # camera 分支网络
        self.camera_modality = False
        if 'img_params' in args:
            self.camera_modality = True
        ...
        # self.fusion = MultiModalFusion_Mamba(modality_args['num_modality'], pc_args['point_pillar_scatter']['num_features'])
