...
class CoVQMF1(nn.Module):   
    def __init__(self, args):
        ...
        if self.use_lidar:
            ...
            cav_lidar_range = pc_args['lidar_range']
            ...
            pc_args['point_pillar_scatter']['grid_size'] = grid_size
    ...
    def forward(self, batch_dict, mode=[0,1], training=True, for_heal=False):
        ...
        if 0 in mode and self.use_lidar:
            ...
            modal_features.append(
                self.minmax_norm(lidar_feature)
            )
            m_len += 1
        ...
        return x, lidar_feature, m_len, rec_loss, svd_loss
