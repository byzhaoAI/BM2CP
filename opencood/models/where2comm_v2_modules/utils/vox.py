...
import math
from opencood.models.where2comm_v2_modules.utils import geom, basic
...
class Vox_util(nn.Module):
    ...
    def get_meta_data(self, B, cam_center, camB_T_camA = None, abs_position=False, assert_cube=False):

        Z, Y, X = self.Z, self.Y, self.X
        xyz_memA = basic.gridcloud3d(B, Z, Y, X, norm=False, device=cam_center.device)  #
