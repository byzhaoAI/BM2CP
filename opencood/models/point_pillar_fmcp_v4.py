...
from opencood.models.fmcp_v4_modules.base_bev_backbone_resnet import ResNetBEVBackbone
from opencood.models.fmcp_v4_modules.attentioncomm import ScaledDotProductAttention, AttenComm
from opencood.models.fmcp_v4_modules.sensor_blocks import ImgCamEncode
...
class PointPillarFMCPV4(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarFMCPV4, self).__init__()
        # cuda选择
