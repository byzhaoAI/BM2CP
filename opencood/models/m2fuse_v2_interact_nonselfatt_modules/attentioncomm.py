...
from opencood.models.m2fuse_v2_modules.mswin import PyramidWindowAttention
    ...
    def __init__(self, args):
        ...
        if self.multi_scale:
            ...
            for idx in range(self.num_levels):
                ...
                # fuse_network = PyramidWindowAttention(args['pwindow_att_config']['dims'][idx], args['pwindow_att_config']['window_size'][idx], args['pwindow_att_config'])
                self.fuse_modules.append(fuse_network)
        else:
            self.fuse_modules = AttenFusion(args['agg_operator']['feature_dim'])
            # self.fuse_modules = PyramidWindowAttention(args['pwindow_att_config']['dims'][idx], args['pwindow_att_config']['window_size'][idx], args['pwindow_att_config'])
