...
from opencood.models.bm2cp_v2_modules.mswin import PyramidWindowAttention
from opencood.models.bm2cp_v2_modules.grid_attention import GridAttEncoder
...
class MultiModalAttenComm(nn.Module):
    def __init__(self, args):
        super(MultiModalAttenComm, self).__init__()
        ...
        if self.multi_scale:
            ...
            self.fuse_modules = AttenFusion(args['in_channels'])
