...
from opencood.models.bm2cpv2_modules.base_bev_backbone_resnet import ResNetBEVBackbone
from opencood.models.bm2cpv2_modules.attentioncomm import ScaledDotProductAttention, AttenComm
from opencood.models.bm2cpv2_modules.sensor_blocks import ImgCamEncode
...
class PointPillarBM2CPV2(nn.Module):
    ...
    def forward(self, data_dict):   # loss: 5.91->0.76
        ...
        _, x = self.camencode(x, image_inputs_dict['depth_map'], record_len)     # x: B*N x C x D x fH x fW(24 x 64 x 41 x 16 x 22) -> 多了一个维度D：代表深度
