...
from opencood.models.realcp_modules.attentioncomm_corr_shapley2 import AttenComm
...
class PointPillarRealCPV2V4Real(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarRealCPV2V4Real, self).__init__()
        # cuda选择
