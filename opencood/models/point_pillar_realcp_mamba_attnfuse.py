...
from opencood.models.realcp_modules.attentioncomm_corr_attnfuse_mamba import AttenComm
...
class PointPillarRealCPMambaAttnFuse(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarRealCPMambaAttnFuse, self).__init__()
        # cuda选择
