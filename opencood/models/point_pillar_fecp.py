...
from opencood.models.fecp_modules.base_bev_backbone_resnet import ResNetBEVBackbone
from opencood.models.fecp_modules.attentioncomm import ScaledDotProductAttention, AttenComm
from opencood.models.fecp_modules.sensor_blocks import ImgCamEncode
...
class PointPillarFECP(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarFECP, self).__init__()
        # cuda选择
