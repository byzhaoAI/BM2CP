...
from opencood.models.realcp_modules.ablation.samp_shapley import AttenComm
...
class PointPillarRealCPM2SampShapley(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarRealCPM2SampShapley, self).__init__()
        # cuda选择
