...
from opencood.models.realcp_modules.ablation.samp_attn import AttenComm
...
class PointPillarRealCPM2SampAttn(nn.Module):
    ...
    def __init__(self, args):
        super(PointPillarRealCPM2SampAttn, self).__init__()
        # cuda选择
