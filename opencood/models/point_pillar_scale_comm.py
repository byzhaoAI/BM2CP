...
from opencood.models.scale_comm_modules.where2comm_attn import Where2comm
from opencood.models.scale_comm_modules.base_bev_backbone_resnet import ResNetBEVBackbone


class PointPillarScaleComm(nn.Module):
    def __init__(self, args):
        super(PointPillarScaleComm, self).__init__()
