...
def load_cross_modal_point_pillar_params(param):
    ...
    param['postprocess'].update({'anchor_args': anchor_args})
    param['preprocess']['args'].update({'vw': vw})
    param['preprocess']['args'].update({'vh': vh})
    param['preprocess']['args'].update({'vd': vd})
    param['preprocess']['args'].update({'T': param['preprocess']['args']['max_points_per_voxel']})
