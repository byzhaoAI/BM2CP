...
# from opencood.utils import box_utils_heal as box_utils
...
class VoxelPostprocessor2(BasePostprocessor):
    def __init__(self, anchor_params, dataset, train):
        super(VoxelPostprocessor2, self).__init__(anchor_params, train)
    ...
    def post_process(self, data_dict, output_dict):
        ...
        # remove large bbx
        keep_index_1 = box_utils.remove_large_pred_bbx(pred_box3d_tensor, dataset=self.dataset)
