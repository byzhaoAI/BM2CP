...
class EarlyFusionDatasetDAIR(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        object_bbx_center_valid, range_mask = box_utils.mask_boxes_outside_range_numpy(object_bbx_center_valid, self.params['preprocess']['cav_lidar_range'], self.params['postprocess']['order'], return_mask=True)
