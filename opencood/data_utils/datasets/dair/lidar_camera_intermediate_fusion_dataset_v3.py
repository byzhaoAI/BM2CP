...
class LiDARCameraIntermediateFusionDatasetDAIR(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for (j, cav_id) in enumerate(cav_id_list):
            ...
            if 'processed_features2' in selected_cav_processed:
                processed_features2.append(selected_cav_processed['processed_features2'])
        ...
        if processed_features2:
            merged_feature_dict2 = merge_features_to_dict(processed_features2)
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose, ego_pose_clean):
        ...
        if self.pre_processor2 is not None:
            ...
            selected_cav_processed.update({
                'processed_features2': processed_lidar2,
            })
    ...
    def collate_batch_train(self, batch):
        ...
        if processed_lidar_list2:
            processed_lidar_torch_dict2 = self.pre_processor.collate_batch(merge_features_to_dict(processed_lidar_list2))
